...
!!! success "Validation"
    Do not seal anything until [wave 1](waves/1-sealed-secrets.md) passed (`kubeseal --fetch-cert` writes a real PEM). Ciphertext sealed to the wrong cert, or to no cert, is paper.
